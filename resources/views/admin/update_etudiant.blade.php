...
@section('content')
    ...
    <div>
        ...
        <form action="{{ route('admin.update-etudiantp', $etudiant->id) }}" method="POST">
            ...
            <div class="row">
                <div class="col-4">
                    <input type="email" class="form-control" name="email" placeholder="Email" value="{{$etudiant->email}}">
                </div>
                <div class="col-4">
                ...
                <div class="col-4" style="margin-top: 1rem">
                    <input type="number" class="form-control" name="telephone" placeholder="Telephone" value="{{$etudiant->telephone}}">
                </div>
                <div class="col-4" style="margin-top: 1rem">
                    <input type="date" class="form-control" name="dan" placeholder="Date de naissance" value="{{$etudiant->date_de_naissance}}">
                </div>
                <div class="col-4" style="margin-top: 1rem">
